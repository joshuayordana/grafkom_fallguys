...
namespace FallGuys
{
    class Window : GameWindow
    {
        ...
        protected override void OnLoad()
        {
            ...
            cube3_.createCuboidFlat(13.0f, 1.6f, 0, 0.5f); //sama dengan createBoxVertices
            cube3_.scale(0.3f, 0.3f, 1);
            ...
            awan7.createEllipsoid(-0.3f, 1.0f, 0, 0.5f, 0.6f, 0.5f, 100, 100);
            objectList.Add(awan7);

            var awan8 = new Asset3d(new Vector3(1, 1, 1));
            awan8.createEllipsoid(0.3f, 1.0f, 0, 0.3f, 0.3f, 0.5f, 100, 100);
            objectList.Add(awan8);

            var awan9 = new Asset3d(new Vector3(1, 1, 1));
            awan9.createEllipsoid(0, 0.7f, 0, 1.0f, 0.3f, 0.5f, 100, 100);
